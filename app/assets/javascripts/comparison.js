    ...
    $('#compare_btn').on('click', function() {
        ...
        $.ajax({
            ...
            .done(function(response) {
                ...
                $('.school1-name').append("<div class='school-name-as-header'>"+ firstSchool + "</div> <div class='stats-small-caption'> Student Population: " + response.first_school_pop + "</div>");
                $('.school2-name').append("<div class='school-name-as-header'>"+ secondSchool + "</div> <div class='stats-small-caption'>Student Population: " + response.second_school_pop + "</div>");
                ...
                table_content_2013.append("<div class='box-to-footer'></div>");
