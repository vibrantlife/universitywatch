		...
		// for(var i = 0; i < 5; i++){	
			// (function(i){
				var intervaler = setInterval(function(){
						var googleMapAPI = "https://maps.googleapis.com/maps/api/geocode/json?address=" + school_address_array[i].split(' ').join('+') + "&key=AIzaSyBJCjCTA6sw9myZEidF3Z_ffxMNpiiJAVg";
